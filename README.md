...
Aplicación web completa desarrollada como proyecto final de Desarrollo de Aplicaciones Web (DAW), enfocada en la venta y personalización de teclados mecánicos.
...
- 🧾 Sistema CRUD de productos (crear, editar, eliminar)
